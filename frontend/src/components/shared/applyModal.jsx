  ...
  return (
    <div>
      <Dialog open={open} onClose={setOpen} className="relative z-50">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 min-h-screen">
          ...
          >
            <div className="px-8 pt-8 pb-6 border-b border-white/10 data-closed:hidden">
              <div className="flex items-start gap-4">
                <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-r from-blue-500/20 to-indigo-600/20 backdrop-blur-sm border border-white/20">
                  <DocumentIcon className="h-6 w-6 text-blue-400" aria-hidden="true" />
                </div>
                <div className="min-w-0 flex-1">
                  ...
                  <Description className="mt-1 text-sm text-gray-300 leading-relaxed">
                    Please select your resume file. Supported formats: PDF, DOC, DOCX (Max 5MB).
                  </Description>
                </div>
              </div>
            </div>
            ...
            <div className="p-8 data-closed:hidden">
              <div className="group">
                ...
                >
                  ...
                  <div className="text-white">
                    <p className="text-lg font-semibold mb-1">Choose your resume</p>
                    <p className="text-sm text-gray-400 mb-4">or drag and drop</p>
                  </div>
                  <input
                    id="resume"
                    name="resume"
              ...
              <p className="mt-3 text-xs text-gray-500 text-center">PDF, DOC, DOCX up to 5MB</p>
            </div>
        ...
        {/* Hidden form */}
        <form id="resume-form" action="/resume" method="POST" enctype="multipart/form-data" className="sr-only">
          <input id="resume-hidden" type="file" name="resume" />
        </form>
      </Dialog>
    </div>
  );
